...
const Banner = () => {
  return (
    ...
    >
       ...
       <p className='font-bold lg:text-6xl md:text-5xl max-sm:text-4xl'>Better Sleep, Better Livning</p>
        <p className='lg:w-[30rem]  max-sm:h-[10rem] md:w-[30rem] max-sm:px-4  text-centerlg:mt-5 mt-2'> Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam 
